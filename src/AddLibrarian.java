	...
	public AddLibrarian() {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
						...
						.addContainerGap())
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup().addGap(20).addGroup(gl_contentPane
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
								.addComponent(btnNewButton, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 181,
										Short.MAX_VALUE)
								.addComponent(btnBack, GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
								.addComponent(textField_2, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 181,
										Short.MAX_VALUE)
								.addComponent(textField_1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 181,
										Short.MAX_VALUE)
								.addComponent(textField, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 181,
										Short.MAX_VALUE)
								.addComponent(passwordField, Alignment.LEADING, 181, 181, Short.MAX_VALUE)
								.addComponent(textField_4, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 181,
										Short.MAX_VALUE)
								.addComponent(textField_3, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 181,
										Short.MAX_VALUE))
						.addGap(111)));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				.createSequentialGroup().addGap(7).addComponent(lblAddLibrarian)
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblContactNo)
						.addComponent(textField_4, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGap(11).addComponent(btnNewButton).addPreferredGap(ComponentPlacement.RELATED, 13, Short.MAX_VALUE)
				.addComponent(btnBack).addGap(19)));
